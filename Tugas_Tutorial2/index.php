...
<html>
    <head>
        ...
        <link rel="icon" href="assets/images/multy-user.png">
        ...
        <div class="container mb-auto">
            <div class="row">
                <div class="col">
                    ...
                    <button type="button" class="btn btn-danger" onclick="window.location='rajaongkir.php'">
                        <i class="fa fa-plus"></i> Add Raja Ongkir
                    </button>
                </div>
                <div class="input-group-prepend col">
                    <input class="form-control-sm py-2 border-right-3 border" type="search" value="search" id="example-search-input">
                        ...
                        <div class="modal-body">
                            <form id="form-user">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="rdblokir" class="form-control-label">blokir:</label>
                                            <div class="custom-control custom-radio" id="rdblokir">
                                                <input type="radio" id="customRadio1" name="blokir" value="Y" class="custom-control-input">
                                                <label class="custom-control-label" for="customRadio1">Yes</label>
                                            </div>
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="customRadio2" name="blokir" value="N" class="custom-control-input">
